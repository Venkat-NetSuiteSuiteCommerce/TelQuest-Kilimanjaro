	...
	,	update: function (data)
		{
			...
			nlapiLogExecution('debug','prefereddata',prefereddata);
			nlapiLogExecution('debug','prefereddatalen',prefereddata.length);
			var custprefered;
			var newchar = "";
			var catsts = Array.isArray(prefereddata);
			nlapiLogExecution('debug','catsts',catsts);
			if(catsts == true)
			{
			...
			nlapiLogExecution('debug','custdata JSON',JSON.stringify(custdata));
			nlapiLogExecution('debug','custdata',custdata);
